...
class UserService:
    ...
    @staticmethod
    def create_user(db: Session, *, obj_in: UserCreate, actor_id: str) -> User:
    ...
    @staticmethod
    def deactivate_user(db: Session, *, db_obj: User, actor_id: str) -> User:
    ...
    @staticmethod
    def soft_delete_user(db: Session, *, db_obj: User, actor_id: str) -> User:
    ...
    @staticmethod
    def change_password(db: Session, *, db_obj: User, new_password: str, actor_id: str) -> User:
