...
export function AssignWaitlistModal({ entry, isOpen, onClose, onSuccess }: AssignWaitlistModalProps) {
  ...
  return (
    <>
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl bg-white rounded-2xl shadow-2xl z-[100] flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
